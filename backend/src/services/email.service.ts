...
export class EmailService {
  ...
  private async sendEmail(to: string, subject: string, html: string): Promise<void> {
    ...
    try {
      ...
      // Log email to console as fallback (works in both dev and prod)
      ...
      console.log('================================================\n');
      console.warn('⚠️  Email not sent - check SendGrid configuration');
      // Don't throw error - allow signup to continue without email
      return;
    }
  }
